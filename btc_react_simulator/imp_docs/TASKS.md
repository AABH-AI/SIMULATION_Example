...
---
**Now:** P0–P5 done. FULL feature parity with original, **verified byte-identical** on Publish CSV (neutral + modified).
**Next (optional):** `git init`, README, pin `highcharts@11.4.8`, code-split the 704 KB bundle.
